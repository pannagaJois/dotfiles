...
vim.opt.softtabstop = 2 -- Editing behaves like tabs of 2 spaces
vim.opt.autoindent = true -- Copy indent from current line
vim.opt.smartindent = false -- Smart auto-indent

vim.opt.shortmess:append 'I' -- hides the default intro message
...
-- changes the default directory to ~/Desktop/code/
vim.cmd 'cd ~/Desktop/code'
    ...
    },
    {
      ...
      config = function()
        require('toggleterm').setup {
          ...
          direction = 'vertical', -- or "horizontal", "float"
          close_on_exit = true,
          shell = vim.o.shell,
        }
      end,
